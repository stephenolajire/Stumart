...
import { usePickerDashboard } from "../constant/GlobalContext";

const CDashboard = ({ onOrderSelect }) => {
  const { data: pickerDashboard, isLoading } = usePickerDashboard();
  ...
  const dashboardData = pickerDashboard || {
    stats: { availableOrders: 0, activeDeliveries: 0, earnings: 0, rating: 0 },
    recent_orders: [],
  };
