...
class StumartWalletAccount(models.Model):
...
class StudentPickerWalletAccount(models.Model):
...
class PickerWalletAccount(models.Model):
...
class WalletTransactionAccount(models.Model):
    TRANSACTION_TYPES = [
        ('tax', 'Tax Collection'),
