        ...
        try:
            ...
            # Handle Regular Picker or Student Picker
                ...
                if picker.user_type == 'picker':
                    picker_wallet, created = PickerWallet.objects.get_or_create(
                    ...
                    picker_wallet, created = StudentPickerWallet.objects.get_or_create(
            ...
            stumart_wallet = StuMartWallet.get_instance()
            if opportunity.picker_type == 'company_rider':
