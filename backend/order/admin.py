...
from django.contrib import admin
from .models import WalletTransaction, PickerWallet, StuMartWallet, CompanyWallet, VendorWallets, StudentPickerWallet, WithdrawalRequest
...
@admin.register(StudentPickerWallet)
